...
var Ani = /** @class */ (function () {
     ...
     */
    Ani.prototype.getVendorPropertyName = function (prop) {
        if (prop in this.div.style)
            return prop;
        // browser prefix
        var prefixes = ['Moz', 'Webkit', '0', 'ms'];
        // property
     ...
     */
    Ani.prototype.checkTransform3dSupport = function () {
     ...
     */
    Ani.prototype.getTransform = function (style) {
        var transform = {};
        var transformStr = style['transform' || this.transform];
     ...
     * @function destroy
     */
    Ani.prototype.destroy = function () {
        return null;
    };
    return Ani;
}());
...
//# sourceMappingURL=a-nimate-bundle.js.map